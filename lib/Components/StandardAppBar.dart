...
class StandardAppBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  StandardAppBar({Key key, this.title, this.color}) : preferredSize = Size.fromHeight(50.0), super (key: key);
...
class _StandardAppBarState extends State<StandardAppBar> {
  ...
  Widget build(BuildContext context) {
    return AppBar(
      ...
      title: Text(widget.title, style: TextStyle(fontFamily: 'NickelodeonNF', fontSize: 35.0)),
      centerTitle: true,
